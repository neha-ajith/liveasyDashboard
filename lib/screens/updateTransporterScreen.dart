...
class UpdateTransporterScreen extends StatefulWidget {
  ...
  UpdateTransporterScreen({Key? key, required this.transporterDetails})
      : super(key: key);
        ...
        child: Row(children: [
          Container(
            ...
            child: TextField(
              ...
              controller: labelText == "Contact" ? null : controller,
              style: TextStyle(
                  color: black, fontSize: 12, fontWeight: normalWeight),
              decoration: InputDecoration(
                  // ignore: unnecessary_null_comparison
                  hintText: controller.text != null ? null : labelText,
                  hintStyle: TextStyle(
                      fontSize: 11,
                      fontWeight: regularWeight,
                      color: labelText == "Contact" ? greyColor : black),
          ...
          child: Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Center(child: Icon(Icons.person_outline, size: 50)),
                    ...
                    Row(children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(color: greyColor.withOpacity(0.80))),
                      ),
